...
class MessageTransformer extends BaseTransformer
{
    ...
    public function transform(Message $message)
    {
        $transformedArray = [
            ...
            'body' => $message->body ? \Str::limit(strip_tags($message->body), 50, '&nbsp;<a href="' . url('messaging/messages/' . $message->hashed_id . '/get_message_body') . '"  data-action="post" data-page_action="appendMessageBody">' . trans('Messaging::labels.message.read_more') . '</a>') : '',
