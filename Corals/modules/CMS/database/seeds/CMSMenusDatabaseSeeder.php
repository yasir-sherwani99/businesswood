    ...
    public function run()
    {
        ...
        \DB::table('menus')->insert([
                ...
                [
                    'parent_id' => $cms_menu_id,
                    'key' => null,
                    'url' => config('cms.models.testimonial.resource_url'),
                    'active_menu_url' => config('cms.models.testimonial.resource_url') . '*',
                    'name' => 'Testimonials',
                ...
                [
                    'parent_id' => $cms_menu_id,
                    'key' => null,
                    'url' => config('cms.models.download.resource_url'),
                    'active_menu_url' => config('cms.models.download.resource_url') . '*',
                    'name' => 'Downloads',
