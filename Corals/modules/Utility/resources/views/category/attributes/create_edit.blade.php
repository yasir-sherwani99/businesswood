            ...
            @component('components.box')
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        {!! CoralsForm::text('properties[icon]','Utility::attributes.attributes.icon',false) !!}
                    ...
                    <div class="col-md-4">
                        @if($attribute->hasMedia($attribute->mediaCollectionName))
                            <img src="{{ $attribute->thumbnail }}" class="img-responsive" style="max-width: 100%;"
                                 alt="Thumbnail"/>
                            <br/>
                            {!! CoralsForm::checkbox('clear', 'Utility::attributes.attributes.clear') !!}
                        @endif
                        {!! CoralsForm::file('thumbnail', 'Utility::attributes.attributes.thumbnail') !!}
                    </div>
                    <div class="col-md-4">
