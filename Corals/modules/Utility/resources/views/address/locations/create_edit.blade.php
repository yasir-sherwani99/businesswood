    ...
    @component('components.box')
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                {!! CoralsForm::text('address','Utility::attributes.location.address', true,null,['onFocus'=>'geolocate()','id'=>'_autocomplete','autocomplete'=>'off','placeholder'=>'Utility::attributes.location.address_placeholder']) !!}
            ...
            <div class="col-md-4">
                ...
                {!! CoralsForm::select('type', 'Utility::attributes.location.type', $locationTypes , false) !!}
                {!! CoralsForm::select('parent_id','Utility::attributes.location.parent', \Address::getLocationsList(), false, null, [], 'select2') !!}
