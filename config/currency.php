...
return [
    ...
    */
    ...
    'drivers' => [
        ...
        'database' => [
            'class' => Corals\Modules\Payment\Common\Drivers\Database::class,
            'connection' => null,
            'table' => 'currencies',
        ],

        'filesystem' => [
            'class' => Corals\Modules\Payment\Common\Drivers\Filesystem::class,
            'disk' => null,
    ...
    */
    ...
    'formatters' => [
        ...
        'php_intl' => [
            'class' => Corals\Modules\Payment\Common\Formatters\PHPIntl::class,
        ],
